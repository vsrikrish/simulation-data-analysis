...
There is no required text for this class, and all course materials will be made available on the [course website](https://bee4850.github.iogit st) or through the Cornell library. However, the following books might be useful as a supplement to/expansion on the topics covered in class:
